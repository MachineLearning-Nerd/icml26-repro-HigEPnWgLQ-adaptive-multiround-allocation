...
---
<!-- trackio-cell
{"type": "code", "id": "cell_d398bb7bc535", "created_at": "2026-07-17T04:35:58+00:00", "title": "Exhaustive greedy optimality and complete evidence run", "command": ["python", "repro/src/run_allocation.py", "--config", "repro/configs/full.json", "--output-dir", "outputs"], "exit_code": 0, "duration_s": 8.633}
-->
````bash
    ...
    "rows": [
      {
        ...
        "states_checked": 25,
        "actions_checked": 56,
        "official_seconds": 0.09731030114926398,
        "oracle_seconds": 0.001260323915630579,
        "max_state_error": 0.0,
        "terminal_value": 2.4
      },
      {
        ...
        "states_checked": 49,
        "actions_checked": 162,
        "official_seconds": 0.12156675709411502,
        "oracle_seconds": 0.0032438321504741907,
        "max_state_error": 0.0,
      ...
      },
      {
        ...
        "states_checked": 81,
        "actions_checked": 352,
        "official_seconds": 0.182714874856174,
        "oracle_seconds": 0.007998323999345303,
        "max_state_error": 0.0,
        "terminal_value": 4.8
      },
      {
        ...
        "states_checked": 121,
        "actions_checked": 650,
        "official_seconds": 0.28944572689943016,
        "oracle_seconds": 0.015282411128282547,
        "max_state_error": 0.0,
        "terminal_value": 6.0
      },
      {
        ...
        "official_seconds": 0.45419788314029574,
        "oracle_seconds": 0.026830924907699227,
        "max_state_error": 0.0,
      ...
      },
      {
        ...
        "official_seconds": 1.024535438977182,
        "oracle_seconds": 0.06845160177908838,
      ...
      },
      {
        ...
        "official_seconds": 2.0087072998285294,
        "oracle_seconds": 0.14443781203590333,
...
---
<!-- trackio-cell
{"type": "artifact", "id": "cell_e52c278ca529", "created_at": "2026-07-17T04:35:58+00:00", "title": "Artifact: dp_scaling.csv", "path": "outputs/dp_scaling.csv", "size": 586, "artifact_type": "dataset", "auto": true}
-->
**📦 Artifact** `outputs/dp_scaling.csv` · dataset · 586 B
...
---
<!-- trackio-cell
{"type": "markdown", "id": "cell_95388d7a75d0", "created_at": "2026-07-17T04:35:59+00:00", "title": "Verdict"}
-->
The official survival-probability greedy allocator is optimal in all **1,881** tested frontier/budget settings. An independent oracle enumerated **72,609** feasible integer allocations. Maximum objective gap and marginal-decomposition identity error were both `8.88e-16`.

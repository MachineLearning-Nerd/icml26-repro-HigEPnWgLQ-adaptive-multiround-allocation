...
---
<!-- trackio-cell
{"type": "code", "id": "cell_60bc97b8fefb", "created_at": "2026-07-17T04:36:08+00:00", "title": "Official PGF DP versus direct convolution", "command": ["python", "repro/src/run_allocation.py", "--config", "repro/configs/full.json", "--output-dir", "outputs"], "exit_code": 0, "duration_s": 8.695}
-->
````bash
    ...
    "rows": [
      {
        ...
        "states_checked": 25,
        "actions_checked": 56,
        "official_seconds": 0.09608100214973092,
        "oracle_seconds": 0.0011339851189404726,
        "max_state_error": 0.0,
        "terminal_value": 2.4
      },
      {
        ...
        "states_checked": 49,
        "actions_checked": 162,
        "official_seconds": 0.12097968300804496,
        "oracle_seconds": 0.0032449171412736177,
        "max_state_error": 0.0,
      ...
      },
      {
        ...
        "states_checked": 81,
        "actions_checked": 352,
        "official_seconds": 0.1758252470754087,
        "oracle_seconds": 0.007526944857090712,
        "max_state_error": 0.0,
        "terminal_value": 4.8
      },
      {
        ...
        "states_checked": 121,
        "actions_checked": 650,
        "official_seconds": 0.2804661348927766,
        "oracle_seconds": 0.015076318057253957,
        "max_state_error": 0.0,
        "terminal_value": 6.0
      },
      {
        ...
        "official_seconds": 0.4505328508093953,
        "oracle_seconds": 0.026211936958134174,
        "max_state_error": 0.0,
      ...
      },
      {
        ...
        "official_seconds": 1.0240569589659572,
        "oracle_seconds": 0.06656415807083249,
      ...
      },
      {
        ...
        "official_seconds": 2.0305032790638506,
        "oracle_seconds": 0.14320728508755565,
...
---
<!-- trackio-cell
{"type": "artifact", "id": "cell_2bc8abb0950f", "created_at": "2026-07-17T04:36:08+00:00", "title": "Artifact: dp_scaling.csv", "path": "outputs/dp_scaling.csv", "size": 587, "artifact_type": "dataset", "auto": true}
-->
...
---
<!-- trackio-cell
{"type": "markdown", "id": "cell_6c220801c106", "created_at": "2026-07-17T04:36:09+00:00", "title": "Verdict"}
-->
The unchanged official truncated-PGF DP equals an independent Bellman recursion using direct `numpy.convolve` transitions. Seven budgets `4,6,8,10,12,16,20` were checked; at `b=20`, all **441** table entries agree, with overall maximum error `1.78e-15`. The executed table/state loops grow polynomially and retain the paper’s quadratic storage structure.
